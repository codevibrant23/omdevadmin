"""
Django settings for omdevadmin project.
...
WSGI_APPLICATION = 'omdevadmin.wsgi.application'
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:3000",
    "http://localhost:5000",
    "https://omdevestates.com",
    "https://www.omdevestates.com",
